...
class AnimalTypePolicy
{
    ...
    {
        return $user->can('view_any_animal::type');
    }
    ...
    {
        return $user->can('view_animal::type');
    }
    ...
    {
        return $user->can('create_animal::type');
    }
    ...
    {
        return $user->can('update_animal::type');
    }
    ...
    {
        return $user->can('delete_animal::type');
    }
    ...
    {
        return $user->can('delete_any_animal::type');
    }
