...
use App\Filament\Resources\RejectedInactiveBidResource\Pages\ListRejectedInactiveBids;
...
class RejectedInactiveBidResource extends Resource
{
    protected static ?string $model = Bid::class;
    protected static ?string $navigationIcon = 'heroicon-o-x-circle';
    protected static ?string $navigationLabel = 'Reprovados - Leilões INATIVOS';
    protected static ?string $pluralLabel = 'Lances Reprovados - Leilões INATIVOS';

    protected static ?string $slug = 'lances-reprovados-leiloes-inativos';

    protected static ?string $navigationGroup = 'Lances';

    protected static ?string $sessionPrefix = '_rejected_inactive_';
    ...
    {
        return [
            'index' => ListRejectedInactiveBids::route('/'),
        ];
    }
}
