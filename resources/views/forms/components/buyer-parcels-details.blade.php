    ...
    <div x-data="{ state: $wire.$entangle('{{ $getStatePath() }}') }">
        ...
        <div class="flex justify-center">
            <p class="fi-section-header-description text-sm text-gray-500 dark:text-gray-400">
                <x-filament::button wire:click="resolveBuyerParcels()">
                    Gerar Parcelas
                </x-filament::button>
                <x-filament::button color="gray" wire:click="hideBuyerParcels()">
        ...
        @if ($this->showBuyerParcels)
            <table class="fi-ta-table w-full table-auto divide-y divide-gray-200 text-start dark:divide-white/5">
                ...
                <tbody class="divide-y divide-gray-200 whitespace-nowrap dark:divide-white/5">
                    ...
                    @foreach ($this->buyerParcels as $key => $parcel)
                                    ...
                                    <div class="fi-ta-text grid w-full gap-y-1 px-3 py-4">
                                        <div class="flex gap-1.5 flex-wrap ">
                                            <div class="flex w-max" style="">
                                                ...
                                                type="date"
                                                wire:model='buyerParcelsDates.{{ $key }}'>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <tr
                        ...
                        <td colspan="2">
                            <x-filament::button wire:click="checkBuyerParcelValues()">
                                Validar Valores
                            </x-filament::button>
                        </td>
                        ...
                        <td
                            ...
                            <div class="fi-ta-text-summary grid gap-y-1 px-3 py-4">
                                ...
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    R$ {{ number_format($this->buyerSum, 2, ',', '.') }}
                                </span>
                            </div>
                        </td>
                        ...
                        <td
                            ...
                            <div class="fi-ta-text-summary grid gap-y-1 px-3 py-4">
                                ...
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    R$
                                    {{ number_format($this->form->getState()['buyer_comission_value'], 2, ',', '.') }}
                                </span>
                            </div>
                        </td>
