    ...
    <section class="flex justify-center items-center py-16 bg-gray-100 min-h-screen">
        <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md flex flex-col">
            ...
            <div id="firstAccessNotice"
                ...
                <strong>Atenção:</strong> Estamos migrando para uma nova plataforma para garantir mais segurança e qualidade
                no atendimento. Por favor, preencha os dados solicitados com atenção.
            </div>
            ...
            <form id="loginForm" class="space-y-5">
                ...
                <div id="firstAccessFields" class="hidden space-y-4 transition-all duration-300 opacity-0">
                    ...
                    {{-- <div class="mt-4 text-center">
                        <a href="https://wa.me/5551999181805" target="_blank"
                            class="inline-flex items-center justify-center gap-2 bg-green-700 hover:bg-green-800 text-white font-semibold py-2 px-4 rounded-lg transition-all">
