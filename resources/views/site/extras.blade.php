...
<div id="cookie-consent"
    class="fixed bottom-0 left-0 right-0 bg-[#003333] text-white p-4 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 z-50 shadow-lg">
    ...
    <button id="accept-cookies"
        class="bg-[#d1b85f] hover:bg-[#e4c46f] text-[#003333] font-semibold py-2 px-4 rounded shadow transition">
        Aceitar
    </button>
</div>
