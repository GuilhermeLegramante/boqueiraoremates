...
@section('content')
    <h1 style="margin-left: 1%; font-size: 18px;">{{ $client->name }}</h1>
    <p style="margin-left: 1%; margin-top: -1%; font-size: 11px;">
        <strong>Cadastrado em:</strong> {{ date('d/m/Y', strtotime($client->created_at)) }}
        <strong>Atualizado em:</strong> {{ date('d/m/Y \à\s H:i:s', strtotime($client->updated_at)) }}
    </p>

    <br>
    <h1 style="margin-left: 1%; font-size: 14px;">Informações Pessoais</h1>
    <table>
        <tbody>
    ...
    <br>
    <h1 style="margin-left: 1%; font-size: 14px;">Contato</h1>
    <table>
        <tbody>
            <tr class="bg-light" style="font-size: 11px;">
    ...
    <br>
    <h1 style="margin-left: 1%; font-size: 14px;">Endereço</h1>
    <table>
        <tbody>
            <tr class="bg-light" style="font-size: 11px;">
                <td class="collumn-left"><strong>CEP:</strong> {{ $client->address->postal_code }}</td>
                <td class="collumn-right"><strong>Logradouro:</strong> {{ $client->address->street }}</td>
            </tr>
            <tr style="font-size: 11px;">
    ...
    <br>
    <h1 style="margin-left: 1%; font-size: 14px;">Informações Bancárias</h1>
    <table>
        <tbody>
            <tr class="bg-light" style="font-size: 11px;">
    ...
    <br>
    <h1 style="margin-left: 1%; font-size: 14px;">Informações Adicionais</h1>
    <table>
        <tbody>
            <tr class="bg-light" style="font-size: 11px;">
            ...
            <tr style="font-size: 11px;">
                <td class="collumn-left"><strong>Cadastro em Leiloeira:</strong>
                    {{ $client->has_register_in_another_auctioneer ? 'SIM' : 'NÃO' }}
                </td>
