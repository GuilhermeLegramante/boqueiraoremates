<div style="--col-span-default: 1 / -1;" class="col-[--col-span-default]">
    <section x-data="{
        ...
        x-on:expand="isCollapsed = false" x-on:open-section.window="if ($event.detail.id == $el.id) isCollapsed = false"
        x-on:toggle-section.window="if ($event.detail.id == $el.id) isCollapsed = ! isCollapsed"
        x-bind:class="isCollapsed & amp; & amp;
        'fi-collapsed'"
        class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10"
        id="data.detalhes-do-parcelamento" data-has-alpine-state="true">
        ...
        <header class="fi-section-header flex flex-col gap-3 overflow-hidden sm:flex-row sm:items-center px-6 py-4">
            ...
            <button
                ...
                type="button" x-on:click.stop="isCollapsed = ! isCollapsed"
